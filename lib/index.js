...
var EZFlux = function (_EventEmitter) {
  ...
  _createClass(EZFlux, null, [{
    ...
    value: function cloneDeep(val) {
      if (!val || (typeof val === 'undefined' ? 'undefined' : _typeof(val)) !== 'object') return val;
  ...
  _createClass(EZFlux, [{
    ...
    value: function addScopeToEventSystem(scopeName, scopeConfig) {
      ...
      var _loop = function _loop(i) {
        ...
        var actionListener = _this2.getActionListener(scopeName, actionName, actionCycle, eventNames);
        var trigger = function trigger(payload) {
          return nextTick(function (res) {
            return _this2.emit(eventNames.triggered, payload, res);
          });
        };

        _this2.actions[scopeName][actionName] = trigger;
        _this2.on(eventNames.triggered, actionListener);
      };
    ...
    value: function getActionListener(scopeName, actionName, actionCycle, eventNames) {
      ...
      return function () {
        var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(payload, res) {
          var stateChange, callAndCheck, success, i;
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  stateChange = Object.seal(_extends({}, _this3.state[scopeName]));
                      ...
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              _context.next = 2;
                              return method(payload, stateChange, _this3, actionName);
    ...
    value: function emit() {
      ...
      if (this.cfg.history.record) {
        this.history[time] = { time: time, name: name, state: this.constructor.cloneDeep(this.state) };
