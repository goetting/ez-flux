  ...
  _createClass(EZFlux, null, [{
    ...
    value: function cloneDeep(val) {
      ...
      for (var _i = keys.length; _i--;) {
        ...
        if (Object.prototype.hasOwnProperty.call(val, key)) objClone[key] = this.cloneDeep(val[key]);
      }
      return objClone;
    }
  }, {
  ...
  function EZFlux() {
    ...
    for (var i = scopeNames.length; i--;) {
      var _stateCfg$scopeNames$ = stateCfg[scopeNames[i]],
          ...
          _values = _stateCfg$scopeNames$.values;


      _this.addScopeToState(scopeNames[i], _values, _actions, state);
    }
    return _this;
  }
