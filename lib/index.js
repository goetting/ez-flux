  ...
  _createClass(EZFlux, [{
    ...
    value: function addScopeToEventSystem(scopeName, scopeConfig) {
      ...
      for (var i = actionNames.length; i--;) {
        ...
        var actionListener = this.getActionListener(scopeName, _actionName, actionCycle, eventNames);
        var actionTrigger = this.getActionTrigger(scopeName, _actionName, eventNames);

        this.actions[scopeName][_actionName] = actionTrigger;
          ...
          return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  stateChange = Object.seal(_extends({}, _this2.state[scopeName]));
                  ...
                  callAndCheck = function () {
                      ...
                      return regeneratorRuntime.wrap(function _callee$(_context) {
                        while (1) {
                          switch (_context.prev = _context.next) {
                            case 0:
                              _context.next = 2;
                              return method(payload, stateChange, _this2, actionName);
                    ...
                    return function callAndCheck(_x6) {
                      return _ref3.apply(this, arguments);
                    };
                  }();

                  success = true;
                  i = actionCycle.length;
                ...
                case 4:
                  ...
                  _context2.next = 7;
                  return callAndCheck(actionCycle[i]);
                ...
                case 10:
                  if (success) {
                    _this2.state = _extends({}, _this2.state, _defineProperty({}, scopeName, _extends({}, stateChange)));
                    Object.freeze(_this2.state);
                    Object.freeze(_this2.state[scopeName]);
                    _this2.emitOrBuffer(eventNames.change, id);
                  }
                  _this2.emitOrBuffer(eventNames.resolved, id);
    ...
    value: function getActionTrigger(scopeName, actionName, eventNames) {
      var _this3 = this;
                ...
                switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    ...
                    eventHandler = function eventHandler(ids) {
                      if (!ids[id]) return;
                      _this3.removeListener(eventNames.resolved, eventHandler);
                      res();
                    };

                    _this3.on(eventNames.resolved, eventHandler);
                    _this3.emit(eventNames.trigger, id, data);
