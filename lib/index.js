...
var EZFlux = function (_EventEmitter) {
  ...
  _createClass(EZFlux, null, [{
    ...
    value: function validateScope(name, _ref) {
      var values = _ref.values,
          ...
          beforeAction = _ref.beforeAction;
  ...
  _createClass(EZFlux, [{
    ...
    value: function addScopeToEventSystem(state, name, scopeConfig) {
      ...
      var beforeAction = scopeConfig.beforeAction,
          afterAction = scopeConfig.afterAction;
      ...
      for (var i = actionNames.length; i--;) {
        ...
        var action = scopeConfig.actions[_actionName].bind(this);

        this.addActionTrigger(name, _actionName);
        this.addActionTriggerListener(state, name, _actionName, action, beforeAction, afterAction);
      }
    }
  }, {
    key: 'addActionTriggerListener',
    value: function addActionTriggerListener(state, scopeName, actionName, action, beforeAction, afterAction) {
      var _this2 = this;
      ...
      this.on(triggerEventName, function () {
        var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee2(id, payload) {
          var stateChange, attemptToAssignResult;
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  attemptToAssignResult = function () {
                    ...
                    return function attemptToAssignResult(_x5) {
                      return _ref3.apply(this, arguments);
                    };
                  }();

                  _context2.next = 4;
                  return attemptToAssignResult(beforeAction);
                ...
                case 4:
                  ...
                  _context2.next = 8;
                  return attemptToAssignResult(action);
                ...
                case 9:
                  ...
                  _context2.next = 13;
                  return attemptToAssignResult(afterAction);
