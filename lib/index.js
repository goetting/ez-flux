  ...
  _createClass(EZFlux, [{
    ...
    value: function addScopeToEventSystem(name, actions, state) {
      ...
      var _loop = function _loop(i) {
        ...
        var action = actions[actionName].bind(_this2);
        ...
        _this2.on(triggerEventName, function (id, payload) {
          var clonedStateValues = _this2.constructor.cloneDeep(state[name]);
          var actionRes = action(payload, clonedStateValues, _this2);
