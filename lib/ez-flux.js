...
var EZFlux = function (_MiniMitter) {
  ...
  _createClass(EZFlux, [{
    ...
    value: function getActionListener(scopeName, actionName, actionCycle, eventNames) {
      ...
      return function (payload, res) {
        ...
        runSeries(actionCycle, function (success) {
          if (success) _this3.setStateScope(scopeName, stateChange, eventNames.change);else _this3.emit(eventNames.canceled);
          res();
        });
      };
    }
    ...
    value: function emit() {
      ...
      _get(EZFlux.prototype.__proto__ || Object.getPrototypeOf(EZFlux.prototype), 'emit', this).call(this, name, payload, res);
